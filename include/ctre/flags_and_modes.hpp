...
struct flags {
    ...
    constexpr CTRE_FORCE_INLINE flags( ctre::singleline v ) { set_flag( v ); }
    constexpr CTRE_FORCE_INLINE flags( ctre::multiline v ) { set_flag( v ); }
    ...
    constexpr friend CTRE_FORCE_INLINE auto operator+( flags f,
    ...
    constexpr CTRE_FORCE_INLINE void set_flag( ctre::case_insensitive ) {
