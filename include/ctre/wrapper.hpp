...
struct regular_expression {
    ...
    constexpr CTRE_FORCE_INLINE static auto multi_exec( Range&& range ) {
        return multi_subject_range< Range, regular_expression >{
            std::forward< Range >( range ) };
    }
    constexpr CTRE_FORCE_INLINE static auto exec() { return Method::exec(); }
    ...
    static constexpr CTRE_FORCE_INLINE auto exec( std::string_view sv ) {
    ...
    CTRE_FORCE_INLINE constexpr auto operator()( Args&&... args ) const {
        return exec( std::forward< Args >( args )... );
    }
    // api for pattern matching
    template < typename... Args >
    CTRE_FORCE_INLINE constexpr auto try_extract( Args&&... args ) const {
        return exec( std::forward< Args >( args )... );
    }
    ...
    template < typename... Args >
    static constexpr CTRE_FORCE_INLINE auto tokenize( Args&&... args ) {
        return regular_expression< RE, tokenize_method, singleline >::exec(
            std::forward< Args >( args )... );
    }
    template < typename... Args >
    static constexpr CTRE_FORCE_INLINE auto iterator( Args&&... args ) {
