...
struct multi_subject_range {
    ...
    struct iterator {
        ...
        constexpr CTRE_FORCE_INLINE iterator( first_type f, last_type l )
    ...
    constexpr CTRE_FORCE_INLINE multi_subject_range( Range r ) : range{ r } {}

    constexpr CTRE_FORCE_INLINE auto begin() const {
        return iterator{ range.begin(), range.end() };
    }
    constexpr CTRE_FORCE_INLINE auto end() const { return end_iterator{}; }
};
